...
public class _012_varReservedName {
	public static void main(String[] args) {
		/*
		 * Beware : The following examples show functionalities incubated in Java 9, but really implemented since Java 10. So var word will compile 
		 * only for java 10+ compliance.
		 * 
		 * Java SE 9 is coming with "var" to define and initialize local variables. The main reasons of this change in the Java Language are :
		...
		/*
			// Commented because var does not compile in jdk9.
		...
		*/
		/*
		 * In Java SE 9, "var" is NOT a keyword. It is a Reserved Type name. That means if our existing code uses var as a variable name, method name, or 
